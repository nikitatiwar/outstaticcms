...
const TroubleShooting = () => {
  ...
  return (
    ...
    <Header/>
    <div 
      className="max-w-7xl grid-cols-2 mx-auto lg:mt-3 xl:mt-5 sm:px-4 lg:px-0"
      data-aos="fade-right"
      data-aos-duration="800"
    >
      <div className="px-3 sm:pr-2 pt-14 pb-6 md:py-0 md:pt-10">
        <h1 className="text-5xl font-semibold text-black xl:text-7xl">
          <span className="block w-full text-center">Troubleshooting</span>
        </h1>
      </div>
    ...
    <div className="pt-4 pb-10 lg:py-24 max-w-7xl mx-auto md:grid grid-cols-[1fr_3fr] gap-12 sm:px-8 lg:px-0">
      ...
      <ul className="border-l border-l-[#d2d5d9] text-base">
        ...
        <Link href="#plansPricing" className="text-gray-700 hover:text-gray-900" onClick={() => scrollToSection("plansPricing")}>Plans & Pricing</Link>
        </li>
        <li className="py-2 pl-4">
        <Link href="#usersLicensing" className="text-gray-700 hover:text-gray-900" onClick={() => scrollToSection("usersLicensing")}>Users & Licensing</Link>
        </li>
        <li className="py-2 pl-4">
        <Link href="#certificates" className="text-gray-700 hover:text-gray-900" onClick={() => scrollToSection("certificates")}>Certificates</Link>
        </li>
        <li className="py-2 pl-4">
        <Link href="#devices" className="text-gray-700 hover:text-gray-900" onClick={() => scrollToSection("devices")}>Devices</Link>
        </li>
      </ul>
      </div>
   <div>   
    <div className="shadow-[0_0.375em_2.8125em_0_#d2d5d9] m-4 mb-6 sm:mb-4 sm:m-0 rounded-lg" id="plansPricing">  
        ...
        {[
          ...
          <li key={index}>
            ...
            >
              ...
              <svg className="flex-shrink-0 w-3 h-3 ml-auto fill-current" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
